        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FatherTagNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    MotherTagNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    DeletedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cattle_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    TargetAgeInMonths = table.Column<int>(type: "int", nullable: false),
                    Dosage = table.Column<double>(type: "float(18)", precision: 18, scale: 2, nullable: false),
                    IntervalInDays = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vaccines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Vaccines_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VetNotes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    DeletedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_HealthLogs_Cattle_CattleId",
                        column: x => x.CattleId,
            ...
            migrationBuilder.CreateTable(
                name: "MilkProductionLogs",
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TenantId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CattleId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AmountInLiters = table.Column<double>(type: "float(18)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MilkProductionLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MilkProductionLogs_Cattle_CattleId",
                        column: x => x.CattleId,
                        principalTable: "Cattle",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TelemetryAlerts_Cattle_CattleId",
                        column: x => x.CattleId,
                        principalTable: "Cattle",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdministeredDate = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    Status = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    DeletedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VaccinationSchedules_Cattle_CattleId",
                        column: x => x.CattleId,
                        principalTable: "Cattle",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cattle_TagNumber",
                table: "Cattle",
                column: "TagNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Cattle_TenantId_Status",
                table: "Cattle",
                columns: new[] { "TenantId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_HealthLogs_CattleId",
                table: "HealthLogs",
                column: "CattleId");

            migrationBuilder.CreateIndex(
                name: "IX_MilkProductionLogs_CattleId",
                table: "MilkProductionLogs",
                column: "CattleId");

            migrationBuilder.CreateIndex(
                name: "IX_MilkProductionLogs_LoggedAt",
                table: "MilkProductionLogs",
                column: "LoggedAt");

            migrationBuilder.CreateIndex(
                name: "IX_MilkProductionLogs_TenantId_LoggedAt",
                table: "MilkProductionLogs",
                columns: new[] { "TenantId", "LoggedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_TelemetryAlerts_CattleId",
                table: "TelemetryAlerts",
                column: "CattleId");

            migrationBuilder.CreateIndex(
                name: "IX_TelemetryAlerts_IsResolved",
                table: "TelemetryAlerts",
                column: "IsResolved");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VaccinationSchedules_CattleId",
